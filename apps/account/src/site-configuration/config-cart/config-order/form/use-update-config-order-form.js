    ...
    handleSubmit(async (values) => {
      ...
      try {
        ...
        await siteConfigurationStore.updateSiteData({
          checkout: { ...siteConfigurationStore.currentSite.checkout, ...requestData },
        });
